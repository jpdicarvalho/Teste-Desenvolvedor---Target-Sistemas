...
// Dados de faturamento mensal (JSON fornecido no problema)
...
function calcularFaturamento(faturamento) {
    // Filtrando apenas os dias com faturamento (> 0)
    const diasComFaturamento = faturamento.filter(dia => dia.valor > 0);

    // Encontrando o menor e maior valor de faturamento
...
console.log("Menor valor de faturamento:", resultado.menorFaturamento.toFixed(2));
